...
/* Models of the provisioner. */
static struct bt_mesh_model root_models[] = {
};

/* Element of the provisioner. */
...
/*
 * Set up data base for new node added into the mesh network.
 */
static void setup_cdb(void)
{
	struct bt_mesh_cdb_app_key *key;

	// alloc memory for now node
...
/* 
 * Configure provisioner itself to mesh network.
 */
...
/*
 * Configure a node like weather station or base node.
 */
...
/*
 * Give signal to main when an unprovision node is discovered.
 */
...
/*
 * Add an unprovision node to bluetooth mesh network.
 */
...
/*
 * Check if a node in the mesh network is unconfigured or not.
 */
